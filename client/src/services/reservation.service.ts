...
const requestList = (email: string): AxiosPromise => axios.post("/getReservations", {email});
const requestRemoval = (email: string, selection: GridRowId[]): AxiosPromise => axios.post("/getReservations", {email, selection});
