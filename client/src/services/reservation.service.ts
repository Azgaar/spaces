...
const requestServices = (reservation: string, services: string[]): AxiosPromise => axios.post("/requestServices", {reservation, services});

export const ReservationService = {list, add, update, remove, requestList, requestRemoval, requestServices};
