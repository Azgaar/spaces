...
const wsCoworking: WorkspaceData = {description: "WS_2", location: "", status: WorkspaceStatus.AVAILABLE, type: WorkspaceType.COWORKING, size: 6, equipment: [Equipment.TELEPHONE, Equipment.COUCH]};
