...
const validate = (schema: ObjectSchema | StringSchema) => (req: Request, res: Response, next: NextFunction): void => {
...
const checkSession = (sessionExpected: boolean) => (req: Request, res: Response, next: NextFunction): void => {
...
const checkRole = (roleExpected: UserRole) => (req: Request, res: Response, next: NextFunction): void => {
